  ...
  return (
    <div className="modal" role="dialog" aria-modal="true" aria-label="Save your progress">
      <div className="modal-body">
        ...
        <p className="small">Sign in with Google to save your home profile and history, and sync across devices.</p>
        <div className="row">
          <button className="primary" onClick={onSignIn}>Continue with Google</button>
